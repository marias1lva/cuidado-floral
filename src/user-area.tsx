          ...
          {role === "doador" && (
            <div className="mt-6">
              <button
                ...
                className="flex items-center gap-2 rounded-xl bg-pink-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm shadow-pink-200 transition-all hover:bg-pink-600 hover:shadow-pink-300 active:scale-95"
              >
